				...
				<div class="card">
					<div class="card-body">
						...
						<div class="app-brand justify-content-center">
							<a href="main.do" class="app-brand-link gap-2"> <span
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1"
                        ...
                        <g id="Brand-Logo"
                          ...
                          <g id="Icon"
							...
							</span> <span class="app-brand-text demo text-body fw-bolder">Login</span>
							</a>
						</div>
						<!-- /Logo -->
						<h4 class="mb-2">Welcome to My Web Site! 👋</h4>
...
<!-- 							<div class="mb-3">
						...
						<p class="text-center">
							<span>New on our platform?</span> <a
								href="memberJoinForm.do"> <span>Create an
									account</span>
							</a>
						</p>
						<p class="text-center">
